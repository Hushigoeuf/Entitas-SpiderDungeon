...
namespace GameEngine
{
    public static class FormatUtility
    {
        ...
        public static string ToDayString(int seconds) =>
            ToTimeString(seconds, TimeFormats.Days | TimeFormats.Hours | TimeFormats.Minutes);

        public static string ToHourString(int seconds) =>
            ToTimeString(seconds, TimeFormats.Hours | TimeFormats.Minutes | TimeFormats.Seconds);

        public static string ToMinuteString(int seconds) =>
            ToTimeString(seconds, TimeFormats.Minutes | TimeFormats.Seconds);
    }
}