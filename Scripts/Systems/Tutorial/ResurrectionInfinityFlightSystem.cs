...
{
    public sealed class ResurrectionInfinityFlightSystem : ReactiveSystem<FlightEntity>, IInitializeSystem
    {
        ...
        public ResurrectionInfinityFlightSystem(Contexts contexts, Services services, Data data) : base(contexts.flight)
        {
            _contexts = contexts;
