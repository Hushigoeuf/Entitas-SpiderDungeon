...
{
    public sealed class GenerationMemoryVer3EnvironmentSystem : ReactiveSystem<EnvironmentEntity>, IInitializeSystem
    {
        ...
        public GenerationMemoryVer3EnvironmentSystem(Contexts contexts, Services services, Data data) : base(
        ...
        {
            _Step_0_StartGeneration();
            _Step_1_GenerateGateIndex();
            _Step_2_GenerateVerifiedIndexes();
            _Step_3_GenerateRandomIndexes();
            _Step_4_GenerateBuildingIndexes();
            _Step_5_StopGeneration();
        }

        // -------------------------------------------------------------------------------------------------------------

        private void _Step_0_StartGeneration()
        {
            if (_memoryEntity.generationMemory.PrefabList.Count != 0)
                _memoryEntity.generationMemory.PrefabList.Clear();
            // Reset Diamond Free Spaces
        ...
        private void _Step_1_GenerateGateIndex()
        {
        ...
        private void _Step_2_GenerateVerifiedIndexes()
        {
        ...
        private void _Step_3_GenerateRandomIndexes()
        {
            for (var j = 0; j < 2; j++)
            {
        ...
        private void _Step_4_GenerateBuildingIndexes()
        {
        ...
        private void _Step_5_StopGeneration()
        {
